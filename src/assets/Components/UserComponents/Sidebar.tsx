    ...
    <div className={`sidebar ${isDarkMode ? 'dark-mode' : ''}`}>
      <div className="sidebar-content">
        <ul className="sidebar-nav">
          ...
          <li>
            <Link
              to="src\assets\Components\UserComponents\NewQuestion.tsx"
              className={`sidebar-link ${location.pathname === 'src\assets\Components\UserComponents\NewQuestion.tsx' ? 'active' : ''}`}
            >
